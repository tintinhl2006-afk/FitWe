...
import { Calendar as CalendarIcon, Clock, User, Check, Users, ChevronRight } from 'lucide-react-native';
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#0f172a' }}>
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 40 }}>
        ...
        <View style={{ marginBottom: 20 }}>
          <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#ffffff' }}>Clases Colectivas</Text>
          <Text style={{ fontSize: 13, color: '#94a3b8', marginTop: 2 }}>
            Reserva tu plaza con antelación en tu gimnasio
          </Text>
        </View>
              ...
              >
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                  <View style={{ flex: 1, marginRight: 8 }}>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#ffffff' }}>{item.title}</Text>
                  ...
                  >
                    ...
                    >
                      {isFull ? 'COMPLETA' : `${item.spotsTotal - item.spotsBooked} plazas`}
                    </Text>
                  </View>
                </View>

                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#334155' }}>
